...
public class BlockRegistry {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        // Stained glass
        register(registry, new BlockModGlass("stained_glass", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass2", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass3", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass4", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass5", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass6", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass7", 0.3F).setTranslationKey("stained_glass"));
        register(registry, new BlockModGlass("stained_glass8", 0.3F).setTranslationKey("stained_glass"));
