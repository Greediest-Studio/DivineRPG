...
public class MobStatInfo {
    ...
    public void initConfig(Configuration cfg, ResourceLocation id) {
        String entityName = id.getPath();

        String comment = new TextComponentTranslation(String.format("entity.%s.%s.name", id.getNamespace(), entityName)).getUnformattedComponentText();
