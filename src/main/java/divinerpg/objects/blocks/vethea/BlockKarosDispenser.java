...
public class BlockKarosDispenser extends BlockModUnbreakable {
    ...
    public void dispense(World world, BlockPos pos) {
        ...
        EntityDivineArrow var11 = new EntityDivineArrow(world, ArrowType.KAROS_ARROW, var5 + 0.5D + par3EnumFacing.getXOffset(), var7 + 0.5D, var9 + 0.5D + par3EnumFacing.getZOffset());
        var11.damageMin = var11.damageMax = 12;
        double var12 = world.rand.nextDouble() * 0.1D + 0.9D;
        var11.motionX = (double)par3EnumFacing.getXOffset() * var12;
        var11.motionY = 0D;
        var11.motionZ = (double)par3EnumFacing.getZOffset() * var12;
